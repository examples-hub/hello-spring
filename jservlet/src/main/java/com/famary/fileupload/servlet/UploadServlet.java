...
//@WebServlet(name = "upload", urlPatterns = {"/file/upload.do"})
...
//		path = "E:/upload/image/" + DateFormatUtils.simpleStrDate();
        path = "/root/Downloads/" + DateFormatUtils.simpleStrDate();
    }

    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("====上传文件测试post");
        //上传文件到指定目录
        List<PartUploadResult> results = PartHandler.newInstance().multipleUpload(path, request.getParts());
